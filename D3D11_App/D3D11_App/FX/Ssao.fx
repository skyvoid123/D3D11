...
float4 PS(VertexOut pin, uniform int gSampleCount) : SV_Target
{
    ...
    float4 normalDepth = gNormalDepthMap.SampleLevel(samNormalDepth, pin.Tex, 0);
    ...
    float3 ranVec = 2.0f * gRandomVecMap.SampleLevel(samRandomVec, 4.0f * pin.Tex, 0).rgb - 1.0f;
    ...
    for (int i = 0; i < gSampleCount; ++i)
    {
        ...
        float3 offset = reflect(gOffsetVectors[i].xyz, ranVec);
        ...
        float rz = gNormalDepthMap.SampleLevel(samNormalDepth, projQ.xy, 0).w;
