...
void InputLayouts::InitAll(ID3D11Device* device)
{
	...
	Effects::FireFX->StreamOutTech->GetPassByIndex(0)->GetDesc(&desc);
	HR(device->CreateInputLayout(InputLayoutDesc::Particle, 5, desc.pIAInputSignature,
		desc.IAInputSignatureSize, &Particle));
}
